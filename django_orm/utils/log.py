...
from django_orm.core.mail import get_connection
from django_orm.core.management.color import color_style
from django_orm.utils.module_loading import import_string

request_logger = logging.getLogger("django_orm.request")

# Default logging for django_orm. This sends an email to the site admins on every
