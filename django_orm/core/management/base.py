...
from django_orm.core.management.color import color_style, no_style
...
def no_translations(handle_func):
    ...
    def wrapped(*args, **kwargs):
        ...
        # bad code if there is an error res is undefined
        # error might be managed in handle_func, so maybe they dont expect any errors in this function
