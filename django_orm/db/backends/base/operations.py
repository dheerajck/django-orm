...
from django_orm.db import NotSupportedError, transaction
...
class BaseDatabaseOperations:
    ...
    compiler_module = "django_orm.db.models.sql.compiler"
    ...
    def sql_flush(self, style, tables, *, reset_sequences=False, allow_cascade=False):
        ...
        color_style() or no_style() in django_orm.core.management.color.
