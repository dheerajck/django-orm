...
from django_orm.db import router
...
class BaseDatabaseCreation:
    ...
    def create_test_db(
        ...
        """
        # Don't import django_orm.core.management if it isn't needed.
    ...
    def serialize_db_to_string(self):
        ...
        def get_objects():
            from django_orm.db.migrations.loader import MigrationLoader
    ...
    def setup_worker_connection(self, _worker_id):
        ...
        # reflected in django_orm.db.connections. If the following line assigned
