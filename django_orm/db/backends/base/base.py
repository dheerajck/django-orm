...
from django_orm.db import DEFAULT_DB_ALIAS, DatabaseError, NotSupportedError
from django_orm.db.backends import utils
from django_orm.db.backends.base.validation import BaseDatabaseValidation
...
from django_orm.db.utils import DatabaseErrorWrapper
from django_orm.utils.asyncio import async_unsafe
...
class BaseDatabaseWrapper:
    ...
    def __init__(self, settings_dict, alias=DEFAULT_DB_ALIAS):
        ...
        # to disambiguate it from django_orm settings modules.
