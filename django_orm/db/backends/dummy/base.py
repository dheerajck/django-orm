"""
Dummy database backend for django_orm.
...
from django_orm.db.backends.base.client import BaseDatabaseClient
...
from django_orm.db.backends.dummy.features import DummyDatabaseFeatures
